...
class WeGetFinancingException extends Exception
{
    ...
    public const PROCESS_PAYMENT_ORDER_NOT_FOUND_CODE = 3;
    public const PROCESS_PAYMENT_ORDER_NOT_FOUND_MESSAGE =
        'Payment process error, order not found for order id: %s';
}
